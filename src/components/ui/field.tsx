    ...
    <div className={cn('min-w-0', className)}>
      <div
        className={cn(
          ...
          '[&_[data-slot=input]]:h-auto [&_[data-slot=input]]:rounded-none [&_[data-slot=input]]:border-0 [&_[data-slot=input]]:bg-transparent [&_[data-slot=input]]:px-0 [&_[data-slot=input]]:py-2 [&_[data-slot=input]]:text-right [&_[data-slot=input]]:text-[15px] [&_[data-slot=input]]:shadow-none [&_[data-slot=input]]:focus-visible:ring-0',
          ...
          '[&_[data-slot=textarea]]:rounded-none [&_[data-slot=textarea]]:border-0 [&_[data-slot=textarea]]:bg-transparent [&_[data-slot=textarea]]:px-0 [&_[data-slot=textarea]]:py-2.5 [&_[data-slot=textarea]]:text-[15px] [&_[data-slot=textarea]]:shadow-none [&_[data-slot=textarea]]:focus-visible:ring-0',
          '[&_[data-slot=picker-trigger]]:h-auto [&_[data-slot=picker-trigger]]:rounded-none [&_[data-slot=picker-trigger]]:border-0 [&_[data-slot=picker-trigger]]:bg-transparent [&_[data-slot=picker-trigger]]:px-0 [&_[data-slot=picker-trigger]]:py-2 [&_[data-slot=picker-trigger]]:text-[15px] [&_[data-slot=picker-trigger]]:focus-visible:ring-0',
