...
- **`transactions`** (23 cols | FK: wallet_id → wallets, related_transaction_id → transactions, category_id → categories, user_id → users, import_batch_id → import_batches, workspace_id → workspaces, partner_id → partners)
- **`users`** (8 cols)
