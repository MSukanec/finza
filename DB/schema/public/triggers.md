...
| categories | copiar_nombre_de_grupo | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION copiar_nombre_de_grupo() |
...
| category_groups | propagar_nombre_de_grupo | AFTER | UPDATE | EXECUTE FUNCTION propagar_nombre_de_grupo() |
