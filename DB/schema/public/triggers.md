...
| categories | log_activity_categories | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_activity() |
| categories | set_updated_at_categories | BEFORE | UPDATE | EXECUTE FUNCTION handle_updated_at() |
| category_groups | log_activity_category_groups | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_activity() |
...
| wallet_reconciliations | log_activity_wallet_reconciliations | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_activity() |
