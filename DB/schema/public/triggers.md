...
|-------|---------|--------|--------|--------|
| budgets | log_activity_budgets | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_activity() |
...
| transactions | log_activity_transactions | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_activity() |
...
| workspaces | log_activity_workspaces | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_activity() |
